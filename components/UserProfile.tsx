        ...
        <div className="w-full md:w-1/3">
          <div className="bg-white rounded-[20px] p-6 shadow-sm border border-gray-100">
            <div className="flex flex-col items-center mb-6">
              ...
              <p className="text-gray-500 text-sm">On Komoti since {user.joinedDate}</p>
            </div>
            
            <div className="mb-6">
              <h2 className="text-lg font-medium mb-2">About Me</h2>
              <p className="text-gray-700">{user.bio || 'No information available'}</p>
            </div>
            
            {user.favoriteSports && user.favoriteSports.length > 0 && (
              <div className="mb-6">
                <h2 className="text-lg font-medium mb-2">Favorite Sports</h2>
